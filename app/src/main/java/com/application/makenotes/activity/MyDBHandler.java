...
public class MyDBHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String create = "CREATE TABLE " + Params.TABLE_NAME + "(" + Params.KEY_ID + " INTEGER PRIMARY KEY,"
                + Params.KEY_TITLE + " TEXT, " + Params.KEY_TIMESTAMP + " TEXT, " + Params.KEY_IMAGES + " TEXT" + ")" ;
...
//        values.put(Params.KEY_IMAGES, notes.getImages());
        values.put(Params.KEY_TIMESTAMP, notes.getTimeStamp());
...
//                Notes.setDescription(cursor.getString(2));
                Notes.setTimeStamp(cursor.getString(2));
...
//        values.put(Params.KEY_DESCRIPTION, Notes.getDescription());
    ...
    public void updateNotesById (int id){
        ...
        // Lets update now
        database.update(Params.TABLE_NAME, values, Params.KEY_ID +"=?" ,
